...
--		{items = {"item_branches"}, chance = 5, duration = 5, limit = 3, units = {} },
		{items = {"item_tango"}, chance = 100, duration = 100, limit = 1, units = {"npc_dummy_unit"}},--50% drop from list with limit
--		{items = {"item_tango_single"}, chance = 100, duration = 10},-- global drop 25%
